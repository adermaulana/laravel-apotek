...
@section('container')
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="col-lg-12">
            ...
            <div class="col-lg-8">
                {{-- Form Edit Pemasok --}}
                <form method="POST" action="{{ route('pemasok.update', $pemasok->id_pemasok) }}" enctype="multipart/form-data" class="mb-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('alamat') is-invalid @enderror" 
                            ...
                            value="{{ old('alamat', $pemasok->alamat_pemasok) }}">
                        @error('alamat')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('telepon') is-invalid @enderror" 
                            ...
                            value="{{ old('telepon', $pemasok->telepon_pemasok) }}">
                        @error('telepon')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <button type="submit" class="btn" 
                        style="background-color:#3a5a40; color:white;">Update Data</button>
                </form>
            </div>
        </div>
    </main>
